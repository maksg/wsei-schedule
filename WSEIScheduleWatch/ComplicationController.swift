...
class ComplicationController: NSObject, CLKComplicationDataSource {
    ...
    func getCurrentTimelineEntry(for complication: CLKComplication, withHandler handler: @escaping (CLKComplicationTimelineEntry?) -> Void) {
        ...
        case .graphicExtraLarge:
            complicationTemplate = graphicExtraLargeTemplate
    ...
    func getLocalizableSampleTemplate(for complication: CLKComplication, withHandler handler: @escaping (CLKComplicationTemplate?) -> Void) {
        ...
        case .graphicExtraLarge:
            handler(graphicExtraLargeTemplate)
        case .utilitarianSmall:
    ...
    private var todayLecture: Lecture? {
        ...
        guard let data = context["lectures"] as? Data, let unsortedLectures = Array(data: data) else { return nil }
        let lectures = unsortedLectures.sorted { $0.fromDate < $1.fromDate }
        return lectures.first//(where: { $0.toDate.isToday && $0.toDate > Date() })
    }
    ...
    private var graphicExtraLargeTemplate: CLKComplicationTemplateGraphicExtraLargeCircular {
        let imageProvider = fullColorImageProvider(named: "Complication/Graphic Extra Large")
